...
function generateDirective(name) {
    ...
    const realPascalCaseFilename = (0, filename_to_pascal_case_1.filenameToPascalCase)(filename);
...
`;
    ...
    console.log('');
    (0, logger_1.success)(`Directive ${filenameCamelCase} created at ${targetFilePath}`);
}
//# sourceMappingURL=generate-directive.js.map