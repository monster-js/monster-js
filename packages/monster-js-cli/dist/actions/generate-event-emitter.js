...
exports.generateEventEmitter = generateEventEmitter;
...
function generateEventEmitter(name) {
    ...
    const filenameCamelCase = (0, filename_to_camel_case_1.filenameToCamelCase)(filename) + 'Event';
...
`;
    ...
    console.log('');
    (0, logger_1.success)(`Event emitter ${filenameCamelCase} created at ${targetFilePath}`);
}
//# sourceMappingURL=generate-event-emitter.js.map