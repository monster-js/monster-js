...
function generateType(name) {
    ...
    const filenamePascalCase = (0, filename_to_pascal_case_1.filenameToPascalCase)(filename) + 'Type';
...
`;
    ...
    console.log('');
    (0, logger_1.success)(`Type ${filenamePascalCase} created at ${targetFilePath}`);
}
//# sourceMappingURL=generate-type.js.map