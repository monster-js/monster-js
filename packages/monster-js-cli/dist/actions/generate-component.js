...
const filename_to_pascal_case_1 = require("../utils/filename-to-pascal-case");
const generate_valid_web_component_selector_1 = require("../utils/generate-valid-web-component-selector");
...
function generateComponent(name, option) {
    ...
    if (fs.existsSync(targetStyleFilePath)) {
        console.log('');
        (0, logger_1.failed)(`The file ${targetStyleFilePath} already exists. Aborting to avoid overwriting.`);
        return;
    }
...
`;
    ...
    console.log('');
    (0, logger_1.success)(`Component ${filenamePascalCase} created at ${targetFilePath}`);
    (0, logger_1.success)(`Component styles created at ${targetStyleFilePath}`);
}
