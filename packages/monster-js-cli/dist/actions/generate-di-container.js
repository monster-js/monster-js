...
exports.generateDiContainer = generateDiContainer;
...
function generateDiContainer(name) {
    ...
    const filenameCamelCase = (0, filename_to_camel_case_1.filenameToCamelCase)(filename) + 'Container';
...
`;
    ...
    console.log('');
    (0, logger_1.success)(`DI container ${filenameCamelCase} created at ${targetFilePath}`);
}
//# sourceMappingURL=generate-di-container.js.map