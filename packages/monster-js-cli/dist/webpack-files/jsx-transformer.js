    ...
    return {
        ...
        visitor: {
            ...
            JSXElement(path) {
                ...
                const bindAttributes = node.openingElement.attributes.filter((attribute) => attribute.value &&
                ...
                const forLoop = node.openingElement.attributes.find((attribute) => attribute.name.type === "JSXNamespacedName" &&
                    attribute.name.namespace.name === "v" &&
                    attribute.name.name.name === "for");
                const forLoopItem = node.openingElement.attributes.find((attribute) => attribute.name.type === "JSXNamespacedName" &&
                    attribute.name.namespace.name === "v" &&
                    attribute.name.name.name === "for-item");
                const forLoopIndex = node.openingElement.attributes.find((attribute) => attribute.name.type === "JSXNamespacedName" &&
                    attribute.name.namespace.name === "v" &&
                    attribute.name.name.name === "for-index");
                const forLoopTrackBy = node.openingElement.attributes.find((attribute) => attribute.name.type === "JSXNamespacedName" &&
                    attribute.name.namespace.name === "v" &&
                    attribute.name.name.name === "for-track-by");
                const directives = node.openingElement.attributes.filter((attribute) => attribute.name.type === "JSXNamespacedName" &&
